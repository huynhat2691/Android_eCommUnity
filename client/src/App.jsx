...
const AdminShopHomePage = lazy(() => import("./pages/Admin/AdminShopHomePage"));
...
function App() {
  ...
  const isLoginUser = location.pathname === "/login";
  ...
  return (
    <div>
      {!isCartPage && !isCheckoutPage && !isHomePage && <ScrollToTop />}
