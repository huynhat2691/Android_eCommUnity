  ...
  return (
    <div className="w-full sm:p-4 h-full">
      <div className="flex flex-col lg:flex-row gap-4">
        {/* Form thêm banner */}
        <Card className="w-full lg:w-2/5 !h-min !border-none !rounded-none !bg-white !text-black">
          <h2 className="text-xl sm:text-2xl font-bold ml-4 mt-4">Quản lý banner</h2>
          <CardHeader>
        ...
        {/* Danh sách banner */}
        <Card className="w-full lg:w-3/5 !border-none !rounded-none !bg-white !text-black">
          <CardHeader>
            <CardTitle className="text-lg sm:text-xl">Danh sách banner</CardTitle>
          </CardHeader>
          <CardContent>
            <ScrollArea className="h-[400px] sm:h-[600px] pr-4">
              ...
              {banners
                ...
                .map((banner) => (
                  <div
                    key={banner._id}
                    className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 p-2 border-b"
                  >
                    <img
                      src={`${backend_url}${banner.image}`}
                      alt=""
                    ...
                    <div className="flex justify-between w-full sm:w-auto sm:justify-start items-center space-x-2">
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          id={`active-${banner._id}`}
                          checked={banner.isActive}
              ...
              <h3 className="text-[14px] sm:text-[16px] font-[500] my-2 sticky top-0 bg-white z-10">
                Banner Popup
              </h3>
              {banners
                .filter((banner) => banner.type === "popup")
                .map((banner) => (
                  ...
                  >
                    <img
                      src={`${backend_url}${banner.image}`}
                      alt=""
                      className="w-full sm:w-[80px] h-auto object-cover flex-shrink-0"
                    />
                    <div className="flex-grow w-full sm:w-auto">
                      <p className="font-semibold">
                        {limitText(banner.title, 30) || "Không có tiêu đề"}
