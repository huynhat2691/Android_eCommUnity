    ...
    <div className="w-full p-2 md:p-4">
      <div className="flex flex-col gap-4">
        ...
        <Card className="w-full !bg-white !text-black">
          <h2 className="text-xl md:text-2xl font-bold ml-4 mt-4">
            Quản lý mã giảm giá
          </h2>
          <CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button variant="outline" className="w-full md:w-auto !bg-white !text-black">
                      {format(coupon.expiryDate, "dd/MM/yyyy")}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0">
            ...
            >
              <CardHeader>
                ...
                <div className="text-sm text-muted-foreground">
                  Mã: <span className="font-medium">{coupon.code}</span>
                </div>
              </CardHeader>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span>
                    <NumericFormat
                      ...
                      decimalSeparator={","}
                      decimalScale={0}
                      suffix={coupon.discountType === "percentage" ? "%" : "₫"}
                    />
                  </span>
                </div>
                <div className="flex justify-between items-center">
              ...
              <CardFooter className="flex gap-2 justify-end">
                <Button onClick={() => handleEdit(coupon)} size="sm" className="!bg-[#27b3e2] !text-white">
                  Sửa
                </Button>
                <Button
                  onClick={() => handleDelete(coupon._id)}
