      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <Card className="!bg-white shadow-lg w-full mx-auto">
          ...
          <CardContent >
            ...
            >
              <SelectTrigger className="w-[180px] mb-4 !bg-white !text-black">
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-center text-gray-600 text-ellipsis overflow-hidden whitespace-nowrap text-xs font-semibold">
                Số lượng
              </TableHead>
              <TableHead className="text-center text-gray-600">
                Tổng cộng
              ...
              adminOrders.slice(0, 5).map((order) => (
                <TableRow key={order._id} className="w-full">
                  ...
                  <TableCell className="text-center">
                    <span
                      className={`px-2 py-1 rounded-full text-ellipsis overflow-hidden whitespace-nowrap text-xs font-semibold ${
