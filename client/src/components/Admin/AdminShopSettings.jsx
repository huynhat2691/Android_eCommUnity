...
const AdminShopSettings = () => {
  ...
  return (
    <Card className="w-full max-w-[95%] mx-auto my-4 rounded-lg border !bg-white !text-black">
      <CardHeader>
        <CardTitle className="text-xl md:text-2xl">Thông tin shop</CardTitle>
        <CardDescription className="text-sm md:text-base">
          Cập nhật thông tin shop tại đây
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="mb-6">
            ...
            <div className="flex items-center justify-center cursor-pointer">
              <div className="h-[40px] font-[600] min-w-[110px] flex items-center justify-center text-[14px] rounded cursor-pointer border bg-[#f5f5f0] hover:bg-[#e6e6e6] transition-all duration-300">
                <input
                  ...
                  onChange={handleImage}
                />
                <Label htmlFor="image" className="cursor-pointer px-4">
                  Chọn ảnh
                </Label>
              </div>
            </div>
        ...
        <form onSubmit={updateHandler} className="space-y-5">
          <div className="space-y-2">
            <Label htmlFor="name" className="text-sm md:text-base">Tên</Label>
            <Input
              id="name"
              value="eCommUnity"
              className="cursor-not-allowed text-sm md:text-base !bg-white !text-black"
            />
          </div>

          <div className="space-y-2">
            <Label htmlFor="description" className="text-sm md:text-base">Mô tả</Label>
            <Textarea
              id="description"
              value={description}
              onChange={(e) => setDescription(e.target.value)}
              placeholder="Nhập mô tả"
              className="min-h-[100px] text-sm md:text-base !bg-white !text-black"
            />
          </div>

          <Button type="submit" className="w-full md:w-auto !bg-[#27b3e2] !text-white">
            Cập nhật
          </Button>
        </form>
      </CardContent>
