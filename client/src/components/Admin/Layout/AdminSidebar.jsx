...
const AdminSidebar = ({ active }) => {
  ...
  return (
    <div className="w-full font-medium flex flex-col justify-start bg-white shadow-sm overflow-y-auto sticky top-0 left-0 z-10 h-[calc(100vh-60px)] custom-scrollbar">
      {/* single item */}
      <div className="w-full flex items-center p-4">
        ...
        >
          ...
          />
          <h5
            className={` 800px:block pl-2 font-[600] text-[gray] ${
          ...
          <AccordionContent>
            ...
            >
              <div className="flex items-center">
                <h5
                  className={` 800px:block text-[14px] ${
