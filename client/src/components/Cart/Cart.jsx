  ...
  return (
    <div className="w-screen mx-auto flex flex-col ">
      <div className="flex-grow overflow-y-auto">
        {cart && cart.length === 0 ? (
          <div className="w-full flex flex-col h-[20rem] items-center justify-evenly bg-white border my-8">
            ...
            <div>
              ...
              <div className="w-full">
                {Object.entries(groupedCart).map(([shopId, shopData]) => (
                  ...
                  >
                    <div className="flex items-center text-[16px] font-[400] p-4 bg-white hover:bg-gray-200 border-b">
                      {/* <input
                        type="checkbox"
      ...
      {cart.length > 0 && (
        <div className="sticky bottom-0 bg-white shadow-lg mt-auto border-t">
          <div className="p-3 py-4">
            <div className="flex items-center justify-between">
              <div className="text-[18px] font-[500] mx-4">
              ...
              <Button
                ...
                className={`!bg-[#ff424e] w-[10rem] h-[2.5rem] rounded-[4px] flex items-center justify-center ml-6 ${
