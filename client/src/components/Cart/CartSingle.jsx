...
const CartSingle = ({
  ...
  return (
    <div className={`p-2 ${noBorder ? "" : "border"} my-4`}>
      <div className="flex items-center">
        <div className="w-full h-[140px] flex items-center justify-between">
          {!hideCheckbox && (
          ...
          <div className="">
            <div>
              <h1 className="line-clamp-2 overflow-hidden break-words max-w-[400px]">
                <div className="flex items-center">
                  ...
                  <p className=" line-clamp-2 overflow-hidden break-words max-w-[400px]">{data.name}</p>
                </div>
                {data.hasClassifications && data.selectedClassification && (
            ...
            <div className="flex items-center justify-between">
              ...
              <div>
                {!hideCheckbox && (
                  <p
                    className="cursor-pointer flex items-center justify-center text-[#27b3e2]"
