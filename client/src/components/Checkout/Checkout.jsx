    ...
    <div className="w-screen mx-auto">
      <div>
        ...
        {Object.entries(groupedSelectedProducts).map(([shopId, items]) => (
          <div key={shopId} className="bg-white mb-4">
            ...
            >
              ...
              <DialogContent className="max-w-[90%] !bg-white !rounded-xl">
                <DialogHeader>
        ...
        <div className="bg-white p-4 flex items-center justify-between ">
          <div className="flex items-center">
            <p className="">Mã giảm giá eCommUnity</p>
          </div>
          <div className="flex items-center justify-between ">
            {adminCouponData ? (
              <span className="text-green-600 font-bold">
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="w-[80%] items-center justify-center !bg-white !rounded-xl">
          <DialogHeader>
