    ...
    <div className=" bg-[#fff] p-4">
      ...
      <div>
        <div className="flex w-full pb-5 border-b mb-2">
          ...
          <h4 className="text-[18px] pl-2 font-[600] text-[#000000b1]" onClick={() => handlePaymentMethodSelect(1)}>
            ...
            <form className="w-full" onSubmit={paymentHandler}>
              <div className="w-full flex pb-3">
                <div className="w-[50%]">
                  ...
                  <Input
                    required
                    className={`${styles.input} !w-[95%] text-[#444] !bg-white !border-gray-200`}
              ...
              <div className="flex items-center justify-end">
                <Button className="!bg-[#f63b60] !text-white my-4 w-[150px]" type="submit">
                  Thanh toán ngay
                </Button>
              </div>
            </form>
      ...
      <div>
        <div className="flex w-full pb-5 border-b">
          ...
          <h4 className="text-[18px] pl-2 font-[600] text-[#000000b1]" onClick={() => handlePaymentMethodSelect(2)}>
        ...
        {select === 2 ? (
          <div className="w-full flex border-b items-center justify-end">
            <Button
              className="!bg-[#f63b60] my-4 w-[150px] !text-white"
      ...
      <div>
        <div className="flex w-full pb-5 border-b mb-2">
          ...
          <h4 className="text-[18px] pl-2 font-[600] text-[#000000b1]" onClick={() => handlePaymentMethodSelect(3)}>
        ...
        {select === 3 ? (
          <div className="w-full flex ">
            ...
            >
              <Button className="!bg-[#f63b60] !text-white mt-4 w-[150px]" type="submit">
                Xác nhận
              </Button>
            </form>
          </div>
