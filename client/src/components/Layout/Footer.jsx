  ...
  return (
    <div className=" bg-white border-t">
      <div className=" lg:w-[1300px] mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6  py-8 sm:text-center">
          ...
          <div className="text-center sm:text-start ">
            <h1 className="mb-3 font-semibold">Phương thức thanh toán</h1>
            <div className="flex justify-center">
              <div className="grid grid-cols-5 gap-5 w-[300px] justify-items-center">
        ...
        <div className="grid grid-cols-1 gap-6 text-center pt-2  text-sm pb-4 items-center">
