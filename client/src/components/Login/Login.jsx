...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#27b3e2] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="mx-auto">
          <div className="bg-white py-8 w-[300px] min-h-[480px] px-4 shadow sm:rounded-lg sm:px-10 rounded-lg">
            <form className="space-y-8" onSubmit={handleSubmit}>
              ...
              <div>
                <Button type="submit" className="w-full duration-300 !bg-[#27b3e2] !text-white">
                  Đăng nhập
                </Button>
              </div>
              <div
