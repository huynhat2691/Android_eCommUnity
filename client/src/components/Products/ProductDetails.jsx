  ...
  return (
    <>
      {!data || !data._id ? (
        ...
        <div className="bg-[#f6f6f5] my-4">
          {data ? (
            <>
              {/* <ProductBreadcrumbs data={data} /> */}
              <div className="w-full flex flex-col justify-between bg-white ">
                <div className="w-full p-2 min-h-[650px]">
                  <div className="">
                    <div className="flex flex-col justify-between items-center mb-32">
                      <div>
                        <ImageGallery
                          items={images}
                    ...
                    <div className="min-h-[400px] flex flex-1 flex-col justify-between mx-2">
                      <div>
                        <div className="flex items-center">
                          ...
                          <h1
                            className={`text-ellipsis flex-nowrap break-words`}
                          >
                            {data.name}
                          </h1>
                        </div>
                        <div className="mt-3">
                          <div className="flex justify-between items-center ">
                            {data?.ratings > 0 ? (
                              ...
                              <p className="">Chưa có đánh giá</p>
                            )}
                          </div>
                          <div>
                            {isAuthenticated ? (
                        ...
                        >
                          <DialogContent className="sm:min-w-screen sm:min-h-[400px] !bg-white !text-black">
                            ...
                            {showReasonList ? (
                              <div className="grid gap-1 py-4 grid-cols-1 items-center justify-items-center">
                                <Button
                                  variant="outline"
                                  onClick={() =>
                                    handleReasonSelect("Sản phẩm giả mạo")
                                  }
                                  className="!bg-[#27b3e2] !text-white !w-[300px]"
                                >
                                  Sản phẩm giả mạo
                                </Button>
                                <Button
                                ...
                                <Button
                                  ...
                                  className="!bg-[#27b3e2] !text-white !w-[300px] !flex !items-start !justify-start group hover:cursor-pointer overflow-hidden"
                                >
                                  <span className="inline-block animate-[marquee_15s_linear_infinite] group-hover:pause whitespace-nowrap">
                        ...
                        <div className="w-full mt-[10px]">
                          ...
                          <div className="flex items-center p-1 w-full bg-gray-100">
                                ...
                                {isAuthenticated ? (
                                  <div className="flex items-center justify-center pt-4">
                                    <Button
                                      ...
                                      className="mr-4 h-[50px] !bg-white"
                                    ...
                                    <Button
                                      className="w-[170px] h-[50px] !bg-[#27b3e2] !text-white"
                                  ...
                                  <Link to="/login">
                                    <div className="flex items-center pt-4">
                                      <Button
                                        ...
                                        className="w-[170px] mr-4 h-[50px] !bg-white"
                                        disabled={isOutOfStock}
                                      >
                                        <span className="flex items-center">
                                          <ShoppingCart
              ...
              <div className="w-full mt-4 bg-white p-6 ">
                <div className="flex items-center">
                  ...
                  <div className="px-4 flex flex-col justify-between">
                    ...
                    <div className="flex justify-between">
                      <Button
                        className="h-[34px] !border-[#27b3e2] !text-[#27b3e2] mr-[10px] !bg-white"
                        variant="outline"
                      ...
                      <Link to={`/shop/preview/${data?.shop?._id}`}>
                        <Button
                          className="h-[34px] !bg-white !border-[#27b3e2]"
                          variant="outline"
                        >
              ...
              <div className="w-full bg-white mt-4 p-6">
                <div>
              ...
              <div className="w-full bg-white mt-4 min-h-full flex flex-col items-center p-6 ">
                      ...
                      <div className="flex items-center w-full">
                        <Tabs defaultValue="all" className="w-full ">
                          <div className="w-full overflow-x-auto scrollbar-hide">
                            <TabsList className="inline-flex min-w-full min-h-[6rem] border p-4 mb-4 bg-[#fffbf8]">
