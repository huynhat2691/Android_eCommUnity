...
const Events = () => {
  ...
  return (
    <div>
      {!isLoading && (
        <Card className="mt-3 py-2 px-4 !border-none !rounded-none !bg-white ">
          <CardHeader className="!p-0 !py-2 !flex-row !items-center justify-between">
            <CardTitle className="text-[18px] font-[600] text-black">Flash Sale</CardTitle>
          ...
          <CardContent className="!px-0">
            {data && data.length !== 0 ? (
              ...
              <div className="text-black text-center h-[100px] flex items-center justify-center">
