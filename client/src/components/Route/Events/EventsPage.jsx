...
const EventsPage = () => {
  ...
  const renderEvents = (events) => (
    <div className="grid grid-cols-2 gap-[20px] md:grid-cols-2 md:gap-[25px] lg:grid-cols-4 lg:gap-[25px] xl:grid-cols-5 xl:gap-2 mb-6 justify-items-center">
  ...
  return (
    <>
      {isLoading ? (
        ...
        <div>
          <Header />
          <div className="w-screen mx-auto mb-4">
