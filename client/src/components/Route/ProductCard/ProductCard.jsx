...
const ProductCard = ({ data, isEvent, isProductPage = false, isBigger = false }) => {
  ...
  const cardWidth = isBigger ? 'w-[180px]' : 'w-[180px]';
        ...
        <div className={`p-2 ${contentHeight}`}>
          ...
          >
            <div className="flex">
              ...
              <h4
                className="text-black h-[45px] font-medium text-[15px] line-clamp-2 overflow-hidden break-words max-w-[300px] transition-colors duration-300 group-hover:text-[#27b3e2]"
                title={data.name}
              >
                {data.name}
              </h4>
