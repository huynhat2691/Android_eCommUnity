...
const AddEvent = () => {
  ...
  return (
    <div className="space-y-4">
      <Card className="!border-none !rounded-none !bg-white !text-black">
        <CardHeader>
      ...
      <Card
        className={`${
          !isEligible ? "pointer-events-none opacity-30 cursor-not-allowed" : ""
        } !border-none !rounded-none !bg-white !text-black`}
      >
        <CardHeader>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-end">
              <Link to="/dashboard/events" className="mr-4 w-full">
