      ...
      {isLoading ? (
        ...
        <Card className="w-full mx-auto !border-none !rounded-none !bg-white !text-black">
          <div className="flex justify-between items-center mb-6">
            <CardHeader>
              <CardTitle className="text-[16px]">Quản lý mã giảm giá</CardTitle>
            </CardHeader>
            <Dialog open={open} onOpenChange={setOpen}>
              <DialogTrigger asChild className="m-3 mx-5">
                <Button className="!bg-[#27b3e2] !text-white">Thêm mã giảm giá</Button>
              </DialogTrigger>
              <DialogContent className="!bg-white">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="flex justify-end">
                    <Button type="submit" className="!bg-[#27b3e2] !text-white">Thêm mã giảm giá</Button>
                  </div>
                </form>
              </DialogContent>
            </Dialog>
          ...
          <CardContent>
            {!coupons || coupons.length === 0 ? (
              <div className="w-full mx-auto !border-none !rounded-none text-center">
                <CardContent>
