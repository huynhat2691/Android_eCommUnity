    ...
    <Card className="w-full mx-auto !border-none !rounded-none flex flex-col h-full !bg-white !text-black">
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="">Quản lý đơn hàng</CardTitle>
      ...
      <CardContent className="flex-grow !py-0">
        <Tabs value={activeTab} onValueChange={handleTabChange}>
          <div className="w-full overflow-x-auto scrollbar-hide">
            <TabsList className="inline-flex min-w-full border bg-[#fffbf8]">
          ...
          <TabsContent value={activeTab}>
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="text-ellipsis overflow-hidden whitespace-nowrap text-xs font-semibold">Mã đơn hàng</TableHead>
                  <TableHead className="text-ellipsis overflow-hidden whitespace-nowrap text-xs font-semibold">Tên sản phẩm</TableHead>
                  <TableHead className="text-ellipsis overflow-hidden whitespace-nowrap text-xs font-semibold">Trạng thái</TableHead>
                  <TableHead className="text-center text-ellipsis overflow-hidden whitespace-nowrap text-xs font-semibold">Số lượng</TableHead>
                  <TableHead className="text-center text-ellipsis overflow-hidden whitespace-nowrap text-xs font-semibold">Tổng cộng</TableHead>
              ...
              <TableBody>
                ...
                {currentOrders.map((order) => (
                  <TableRow key={order._id}>
                    ...
                    <TableCell className="text-ellipsis overflow-hidden whitespace-nowrap text-xs font-semibold max-w-[200px]">
                    ...
                    <TableCell className="text-ellipsis overflow-hidden whitespace-nowrap text-xs font-semibold">
                      <span
                        className={
