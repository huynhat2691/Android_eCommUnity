  ...
  return (
    <div className="w-full p-4 bg-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card className="!bg-white !text-black shadow-md hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            ...
            <Link to="/dashboard/withdraw-money">
              <Button variant="outline" className="mt-2 !bg-white !text-black">
                Thanh toán
              </Button>
            </Link>
          </CardContent>
      ...
      <Card className="!bg-white !text-black shadow-md">
        ...
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="text-center text-ellipsis overflow-hidden whitespace-nowrap text-xs font-semibold">Mã đơn hàng</TableHead>
                ...
                <TableHead className="text-center text-ellipsis overflow-hidden whitespace-nowrap text-xs font-semibold">Chi tiết đơn hàng</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {orders &&
