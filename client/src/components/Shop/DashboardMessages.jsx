...
const DashboardMessages = () => {
  ...
  return (
    <Card className="w-full !border-none !rounded-none h-full md:h-[51rem]">
      <CardContent className="p-0 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/3 border-b md:border-b-0 md:border-r">
          ...
          <ScrollArea className="md:h-[calc(100%-4rem)]">
            {conversations.length === 0 ? (
              <div className="flex items-center justify-center p-6 !bg-white !text-black">
                <p className="text-xl md:text-2xl">Chưa có tin nhắn nào</p>
              </div>
            ) : (
              <>
                {/* Phần pinnedConversations giữ nguyên */}
        ...
        <div className="w-full md:w-2/3 !bg-white !text-black">
          {currentChat ? (
            ...
            <div className="flex items-center justify-center h-[300px] md:h-full">
...
const MessageList = ({
  ...
  return (
    ...
    >
      <Button
        variant="ghost"
        className="flex-grow h-16 md:h-[4rem] justify-start p-2 md:p-3"
        onClick={handleClick}
      >
        <Avatar className="w-10 h-10 md:w-12 md:h-12 mr-2 md:mr-3">
          <AvatarImage
        ...
        <div className="text-left">
          <p className="font-semibold flex items-center text-sm md:text-base">
            {user?.name}
            {isPinned && <Pin className="ml-2 h-3 w-3 md:h-4 md:w-4" />}
          </p>
          <p className="text-xs md:text-sm text-muted-foreground truncate w-32 md:w-40">
            {data.lastMessage || "Bắt đầu cuộc trò chuyện"}
          </p>
        </div>
        {online && (
          <div className="w-2 h-2 md:w-3 md:h-3 bg-green-500 rounded-full ml-auto mr-2" />
        )}
...
const SellerInbox = ({
  ...
  return (
    <div className="flex flex-col h-[400px] md:h-[810px]">
      {/* Header */}
      <div className="flex-shrink-0 flex items-center justify-between p-3 md:p-4 bg-[#00a8ff] text-white">
      ...
      {/* ScrollArea */}
      <ScrollArea ref={scrollAreaRef} className="flex-grow p-2 md:p-3">
        {messages &&
              ...
              >
                {item.images && (
                  <img
                    src={item.images}
                    alt=""
                    className="max-w-[200px] md:max-w-[300px] object-cover rounded-[10px] mb-1"
                  />
                )}
      ...
      <form
        ...
        className="flex-shrink-0 p-2 md:p-3 border-t bg-white"
      >
        {images && (
          <div className="w-full mb-2 relative">
            <img
              src={images}
              alt="Preview"
              className="size-[40px] md:size-[50px] object-cover rounded-[10px]"
            />
            <button
              type="button"
              onClick={handleRemoveImage}
              className="absolute -top-2 left-8 md:left-10 bg-red-500 text-white rounded-full w-4 h-4 md:w-5 md:h-5 flex items-center justify-center"
            >
        ...
        <div className="flex w-full">
          ...
          <Input
            ...
            className="flex-grow text-sm md:text-base !bg-white !text-black"
          />
