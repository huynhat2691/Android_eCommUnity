    ...
    <div className="w-full">
      ...
      <Tabs defaultValue="all" onValueChange={setActiveTab}>
        <div className="overflow-x-auto scrollbar-hide">
          <TabsList className="w-max min-w-full flex !bg-white !text-black">
            <TabsTrigger value="all" className="whitespace-nowrap px-4">
              Tất cả sản phẩm
            </TabsTrigger>
            <TabsTrigger value="flashSale" className="whitespace-nowrap px-4">
              Flash sale
            </TabsTrigger>
            ...
            {uniqueCategories.length > 3 && (
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="whitespace-nowrap px-4">
                    Thêm
                  </Button>
                </PopoverTrigger>
                <PopoverContent>
            ...
            <TabsTrigger value="reviews" className="whitespace-nowrap px-4">
              Đánh giá
            </TabsTrigger>
          </TabsList>
        </div>
            ...
            <div className="flex items-center">
              <Button
                ...
                className={`mr-2 p-2 border rounded !bg-white ${
                  sortBy === "newest" ? "!bg-[#27b3e2] !text-white !border-none" : ""
                }`}
              ...
              <Button
                ...
                className={`mr-2 p-2 border rounded !bg-white ${
                  sortBy === "bestSelling" ? "!bg-[#27b3e2] !text-white !border-none" : ""
                }`}
              >
                Bán chạy
              </Button>
        ...
        <TabsContent value="all">
          <div className="grid grid-cols-2 gap-5 md:grid-cols-2 md:gap-[25px] lg:grid-cols-3 lg:gap-[25px] xl:grid-cols-5 xl:gap-3 mt-4">
            {isSearching ? (
        ...
        <TabsContent value="reviews">
          <Tabs value={activeReviewTab} onValueChange={setActiveReviewTab}>
            <TabsList className="w-full min-h-[6rem] border p-4 mb-4 !bg-[#fffbf8] flex flex-col md:flex-row">
              {/* Rating Overview Section */}
              <div className="w-full md:w-auto mb-4 md:mb-0 flex flex-col items-center justify-center md:mr-6">
              ...
              <div className="overflow-x-auto scrollbar-hide">
                <div className="flex md:flex-wrap gap-2 min-w-max">
                  <TabsTrigger
                    value="all"
                    className="border px-4 h-[40px] whitespace-nowrap data-[state=active]:text-[#27b3e2] data-[state=active]:border-[#27b3e2]"
                  >
                    Tất cả
                  </TabsTrigger>
                  {[5, 4, 3, 2, 1].map((star) => (
              ...
              {filterReviews(allReviews, activeReviewTab)?.map(
                (review, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="flex flex-col md:flex-row items-start p-3 border-b"
                    >
                      <div className="flex items-start w-full md:w-auto">
                        ...
                        <div className="flex-grow">
                          ...
                          {/* Product Info */}
                          {product && (
                            <div className="flex items-start mt-3 w-full md:w-[350px] h-[55px] !bg-[#f5f5f5] rounded border">
                              <img
