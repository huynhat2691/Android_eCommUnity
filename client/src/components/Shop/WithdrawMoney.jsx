...
const WithdrawMoney = () => {
  ...
  return (
      ...
      <Card className="w-full h-screen !bg-white !text-black !border-none !rounded-none">
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button
                ...
                className="!bg-[#27b3e2] !text-white"
              >
                  ...
                  {seller && seller?.withdrawMethod ? (
                    <div className="grid gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <Button onClick={withdrawHandler} className="!bg-[#27b3e2] !text-white">Thanh toán</Button>
                      </div>
                    </div>
                  ) : (
                    <div className="grid gap-4">
                      <p className="text-center">Chưa có phương thức thanh toán nào</p>
                      <Button onClick={() => setPaymentMethod(true)} className="!bg-[#27b3e2] !text-white">
                        Thêm phương thức thanh toán
                      </Button>
                    </div>
                  )}
