  ...
  return (
    <div className="">
      ...
      <Tabs defaultValue="all" onValueChange={setActiveTab}>
        <TabsList className="w-full !bg-white !text-black">
        ...
        <TabsContent value="all">
          <div className="grid grid-cols-2 gap-[20px] md:grid-cols-2 md:gap-[25px] lg:grid-cols-3 lg:gap-[25px] xl:grid-cols-5 xl:gap-2 mt-4">
            {isSearching ? (
