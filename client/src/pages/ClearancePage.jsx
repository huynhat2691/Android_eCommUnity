    ...
    <div>
      ...
      <div className="w-screen mx-auto">
        {hasClearanceProducts ? (
              ...
              return (
                <div key={category.id} className="mb-6 p-4">
                  <div className="flex justify-center">
                    <div className=" border-white border-[2px] mb-6 rounded-full bg-[#27b3e2] text-white">
          ...
          <div className="w-full flex flex-col h-[29rem] items-center justify-evenly bg-white border rounded-lg my-2">
