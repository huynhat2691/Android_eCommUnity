...
import ProductCard from "../components/Route/ProductCard/ProductCard";
import { Separator } from "../components/ui/separator";
import { ChevronRight, ChevronUp, Filter, List } from "lucide-react";
import { getAllSellersAdmin } from "../redux/actions/seller";
import { Button } from "../components/ui/button";
import { Label } from "../components/ui/label";
import {
...
const ProductsPage = () => {
  ...
  return (
    <div className="w-full">
      <Header />
      <div className="w-full max-w-[1300px] mx-auto bg-white border flex">
        {/* Mobile Filter Button */}

        {/* Product List Section */}
        <div className="w-full lg:w-4/5 p-4">
          {/* Sort Controls */}
          <div className="flex sm:flex-row justify-between items-start sm:items-center mb-4 gap-2">
            <div className="lg:hidden">
              <Sheet>
                <SheetTrigger asChild>
                  <Button
                    variant="outline"
                    className="w-16 !p-1 flex items-center gap-1 !bg-[#27b3e2] !text-white !border-none"
                  >
                    <Filter size={16} />
                    Lọc
                  </Button>
                ...
                <SheetContent
                  side="left"
                  className="w-[300px] sm:w-[400px] p-0 h-full !bg-white !text-black"
                >
                  <div className="flex flex-col h-full">
                    <SheetHeader className="p-6 pb-0 ">
                      <SheetTitle className="!text-black">Bộ lọc</SheetTitle>
                    </SheetHeader>
                    ...
                    <div className="flex-1 overflow-y-auto px-6">
                      <SheetDescription>
                        ...
                        <div className="py-4">
                          ...
                          <Separator />
                          {category && (
                            <div className="py-2 text-[15px] !text-black">
                              <div
                                className={`flex  flex-row items-center cursor-pointer p-2 hover:bg-[#dadada] hover:rounded-lg hover:transition hover:ease-in-out hover:duration-200  ${
                                  activeCategory === category.id
                                    ? "!text-[#27b3e2]"
                        ...
                        activeSubcategory === subcategory.id
                          ...
                          <div className="mb-4 !text-black">
                            ...
                            <Button
                              variant="outline"
                              onClick={() =>
                                setPriceRangePreset(100000, 500000)
                              }
                              className="m-1 p-2 border rounded !bg-[#27b3e2] !text-white !border-none"
                            >
                              100k - 500k
                            ...
                            <Button
                              variant="outline"
                              onClick={() =>
                                setPriceRangePreset(500000, 1000000)
                              }
                              className="m-1 p-2 border rounded !bg-[#27b3e2] !text-white !border-none"
                            >
                              500k - 1tr
                            ...
                            <Button
                              variant="outline"
                              onClick={() =>
                                setPriceRangePreset(1000000, 1000000000)
                              }
                              className="m-1 p-2 border rounded !bg-[#27b3e2] !text-white !border-none"
                            >
                              Trên 1tr
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2">
                <Button
                  ...
                  onClick={() => setSortBy("newest")}
                  className={
                    sortBy === "newest" ? "!bg-[#27b3e2] !text-white !border-none" : " !bg-white !text-black"
                  }
                >
                  Mới nhất
                </Button>
                <Button
                  ...
                  onClick={() => setSortBy("bestSelling")}
                  className={
                    sortBy === "bestSelling" ? "!bg-[#27b3e2] !text-white !border-none" : " !bg-white !text-black"
                  }
                >
                  Bán chạy
                </Button>
          ...
          {/* Product Grid */}
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 sm:gap-4">
            {filteredProducts &&
              filteredProducts.map((i, index) => (
                <ProductCard data={i} key={index} isProductPage={true} />
              ))}
          ...
          {filteredProducts && filteredProducts.length === 0 && (
            <h1 className="text-center w-full text-[20px] flex items-center justify-center">
              Không tìm thấy sản phẩm nào!
            </h1>
          )}
        </div>
